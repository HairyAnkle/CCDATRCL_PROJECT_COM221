...
public class ContactList_Frame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        contactList.getTableHeader().setReorderingAllowed(false);
    ...
    private void addContactActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addContactActionPerformed
        ...
        if (name != null && phoneNumber != null) {
            if (!phoneNumberExists(root, phoneNumber)) {
                root = insertNode(root, name, phoneNumber);
                updateTable();
                jTextArea1.setText(String.format("Added %s to the contact list.", name));                
            } else {
                JOptionPane.showMessageDialog(this, "The phone number you entered is already in use.");
            } 
        }else {
    ...
    private boolean phoneNumberExists(Contact root, String phoneNumber) {
        if (root == null) {
            return false;
        }

        if (phoneNumber.equals(root.phone_number)) {
            return true;
        } else if (phoneNumber.compareTo(root.phone_number) < 0) {
            return phoneNumberExists(root.left, phoneNumber);
        } else {
            return phoneNumberExists(root.right, phoneNumber);
        }
    }
    ...
    private void find_max_numberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_find_max_numberActionPerformed
        ...
        else JOptionPane.showMessageDialog(this, "The contact list is empty");
